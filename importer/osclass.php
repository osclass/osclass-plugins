...
function osclass_houses() {
    ...
    if(osc_count_items()) {
        while(osc_has_items()) {
            $item = oscfeed_get_house_data(osc_item());
            ...
            if(osc_count_item_resources()>0) {
                while(osc_has_item_resources()) {
                    if(strpos(osc_resource_type(), 'image')!==FALSE) {
                        $res_string .= '<image>
                                            <image_url><![CDATA['.osc_resource_url().']]></image_url>
                                            <image_title><![CDATA['.osc_resource_id().']]></image_title>
                                        </image>';
                    }
                }
            }
...
function osclass_products() {
    ...
    if(osc_count_items()) {
        while(osc_has_items()) {
            ...
            $item = oscfeed_get_product_data(osc_item());
            ...
            if(osc_count_item_resources()>0) {
                while(osc_has_item_resources()) {
                    if(strpos(osc_resource_type(), 'image')!==FALSE) {
                        $res_string .= '<image>
                                            <image_url><![CDATA['.osc_resource_url().']]></image_url>
                                            <image_title><![CDATA['.osc_resource_ide().']]></image_title>
                                        </image>';
                    }
                }
            }
...
function osclass_jobs() {
    ...
    if(osc_count_items()) {
        while(osc_has_items()) {
            $item = oscfeed_get_job_data(osc_item());
...
function osclass_cars() {
    ...
    if(osc_count_items()) {
        while(osc_has_items()) {
            $item = oscfeed_get_car_data(osc_item());
