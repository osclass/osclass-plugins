    ...
    <div style="padding: 20px;">
        <div>
            <fieldset>
                ...
                <?php _e('Sitemap file generation could take some resources and time depending on how big your website is. We strongly suggest to tun it manully via a system\'s cron. To achieve that, you should modify index.php file, and comment or remove tha last line (osc_add_hook(\'cron_daily\', \'sitemap_generator\');) and run manual_cron.php instead on your system\'s cron', 'sitemap_generator'); ?>.
            </fieldset>
        </div>
    </div>
</div>