        ...
        <div style="float: left; width: 50%;">
            <fieldset>
                <legend><?php _e('Jobs Options', 'jobs_attributes'); ?></legend>
                    ...
                    <label for="enabled_comments"><?php _e('Allow upload of resumes'); ?></label>
                    <br/>
                    ...
                    <label for="enabled_comments"><?php _e('Allow unregistered users to upload their resumes'); ?></label>
                    <br/>
                    ...
                    <label for="enabled_comments"><?php _e('Send all emails to the following email (if not checked the resumes will be send to ad\'s author)'); ?></label>
                    <br/>
