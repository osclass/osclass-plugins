...
<div id="killerquestions">
    ...
    <div id="question_<?php echo $q['pk_i_id']; ?>" data-id="<?php echo $q['pk_i_id']; ?>" class="new_question">
        ...
        ?>
        <a href="javascript:void(0);" class="delete_question_ico delete_question" data-question-id="<?php echo $q['pk_i_id']; ?>"></a>
        ...
        <div class="containerAnswers">
            ...
            <ol>
                ...
                <li>
                    <input <?php if( $kf_status === 'disabled' ) { ?>disabled="disabled"<?php } ?> class="input-large" type="text" name="question[<?php echo $q['pk_i_id'];?>][answer][<?php echo $a['pk_i_id'];?>]" value="<?php echo osc_esc_html($a['s_text']);?>"/>
                    <?php _punctuationSelect_update($q['pk_i_id'], $a['pk_i_id'], $a['s_punctuation'], (($kf_status === 'disabled') ? true : false)); ?>
                </li>
                <?php }
                ...
                <li>
                    <input <?php if( $kf_status === 'disabled' ) { ?>disabled="disabled"<?php } ?> class="input-large" type="text" name="question[<?php echo $q['pk_i_id'];?>][new_answer][<?php echo $aux;?>]" />
                    <?php _punctuationSelect_insert($q['pk_i_id'], $aux, '', (($kf_status === 'disabled') ? true : false) ); ?>
                </li>
                <?php } ?>
            </ol>
        </div>
