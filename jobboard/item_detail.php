...
<div id="apply_job">
    <form id="job_apply_form" action="<?php echo osc_base_url(true)."?page=custom&file=".osc_plugin_folder(__FILE__)."apply.php" ;?>" method="post" enctype="multipart/form-data" >
        ...
        <div class="row">
            <label for="job_name"><?php _e('Name', 'jobboard'); ?></label>
        ...
        <div class="row">
            <label for="job_email"><?php _e('E-mail', 'jobboard'); ?></label>
        ...
        <div class="row">
            <label for="job_cover_letter"><?php _e('Do you want to tell us something?', 'jobboard'); ?></label>
        ...
        <?php if(osc_get_preference('allow_cv_upload', 'jobboard_plugin')>0) { ?>
            <div id="cv_uploader">
                <noscript>
                    <p><?php _e('Please enable JavaScript to use cv uploader', 'jobboard'); ?>.</p>
                </noscript>
            </div>
            <div class="row">
                <label for="job_resume"><?php _e('Select your resume', 'jobboard'); ?></label>
...
<script>
    $(document).ready(function(){
        ...
        $("form[id=job_apply_form]").validate({
            ...
            messages: {
                job_email: {
                    required: "<?php _e("Email: this field is required", "jobboard"); ?>.",
                    email: "<?php _e("Invalid email address", "jobboard"); ?>."
                },
                job_name: {
                    required: "<?php _e("Name: this field is required", "jobboard"); ?>."
                },
                job_cover_letter: {
                    minlength: "<?php _e("Cover letter: enter at least 5 characters", "jobboard"); ?>."
                }
            },
