...
<?php } ?>
    <iframe id="apply_with_linkedin_frame" name="apply_with_linkedin_frame"
        <?php if( osc_get_osclass_location() == 'contact' ) { ?>
            style="display:none; width: 191px; height:45px; z-index:1;padding-left: 60px;"
            height="45" width="191" scrolling="no"
        <?php } else { ?>
            style="display:none; width: 245px; height:45px; z-index:1;"
            height="45" width="245" scrolling="no"
        <?php } ?>
