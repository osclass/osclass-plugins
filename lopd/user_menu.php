            ...
            <div class="content user_account">
                ...
                <div id="main">
                    ...
                    <?php if(ModelLOPD::newInstance()->couldDelete(osc_logged_user_id())) { ?>
                        ...
                        <a href="<?php echo osc_route_url('lopd-user', array('confirm' => 'true', 's' => $user['s_secret'])); ?>" /><?php _e('Entiendo los riesgos y desde BORRAR MI CUENTA', 'lopd'); ?></a>
                    <?php } else { ?>
                        <h3><?php _e('En estos momentos no puede borrar su cuenta.', 'lopd'); ?></h3>
                        <p><?php echo sprintf(__('Posiblemente tenga algún pago o algún otro asunto pendiente en la web y su cuenta no puede ser borrada en estos momentos. Si aún así desea borrar su cuenta, por favor contacte con nosotros.', 'lopd'), osc_contact_url()); ?></p>
                    <?php }; ?>
                </div>
            </div>
