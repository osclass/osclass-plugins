<?php
     ...
     * Save User form
     */
    if ( Params::getParam('plugin_action') == 'user' ) {
...
<div id="settings_form" style="border: 1px solid #ccc; background: #eee; ">
    <div style="padding: 20px;">
        <div style="float: left; width: 100%;">
            ...
            <form id="richedit_form" action="<?php echo osc_admin_base_url(true); ?>?page=plugins&action=renderplugin&file=<?php echo osc_plugin_folder(__FILE__).'conf.php'; ?>" method="POST">
                <input type="hidden" name="plugin_action" value="user" />
