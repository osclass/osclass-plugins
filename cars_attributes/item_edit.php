...
<div class="box">
    ...
    <div class="row _20">
	<input type="checkbox" name="warranty" id="warranty" value="1" <?php if($detail['b_warranty']==1) {echo 'checked="yes"';};?> /> <label><?php _e('Warranty'); ?></label> <br />
    </div>
    <div class="row _20">
	<input type="checkbox" name="new" id="new" value="1" <?php if($detail['b_new']==1) {echo 'checked="yes"';};?> /> <label><?php _e('New'); ?></label> <br />
    </div>
