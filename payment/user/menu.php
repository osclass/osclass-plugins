...
<div class="content user_account">
    ...
    <div id="main">
        <h2><?php _e('Paypal & your items', 'payment'); ?></h2>
        <?php if(osc_count_items() == 0) { ?>
            <h3><?php _e('You don\'t have any items yet', 'payment'); ?></h3>
        <?php } else { ?>
            <?php while(osc_has_items()) { ?>
                    <div class="item" >
                            ...
                            <p>
                            <?php _e('Publication date', 'payment') ; ?>: <?php echo osc_format_date(osc_item_pub_date()) ; ?><br />
